# structured-ai-output-normalization

## Purpose
Capture the accepted behavior for the `structured-ai-output-normalization` capability after the `fix-real-pdf-ai-endpoints` change.
